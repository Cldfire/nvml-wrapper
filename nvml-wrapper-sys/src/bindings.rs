/* automatically generated by rust-bindgen 0.35.0 */
/* mod `field_id` created by hand */
...
pub const NVML_API_VERSION: u32 = 9;
pub const NVML_API_VERSION_STR: &'static [u8; 2usize] = b"9\0";
...
pub const NVML_MAX_VGPU_TYPES_PER_PGPU: u32 = 17;
pub const NVML_MAX_VGPU_INSTANCES_PER_PGPU: u32 = 24;
pub const NVML_GRID_LICENSE_FEATURE_MAX_COUNT: u32 = 3;
pub const NVML_GRID_LICENSE_INFO_MAX_LENGTH: u32 = 128;
...
pub const nvmlMemoryLocation_enum_NVML_MEMORY_LOCATION_COUNT: nvmlMemoryLocation_enum = 7;
...
extern "C" {
    pub fn nvmlDeviceGetGridLicensableFeatures(
        device: nvmlDevice_t,
