...
pub struct NvmlLib {
    ...
    pub nvmlDeviceGetPowerUsage: Result<
        ...
        ::libloading::Error,
    >,
    pub nvmlDeviceGetPowerMode: Result<
        unsafe extern "C" fn(device: nvmlDevice_t, powerModeId: *mut raw::c_uint) -> nvmlReturn_t,
        ::libloading::Error,
    >,
    pub nvmlDeviceGetSupportedPowerModes: Result<
        unsafe extern "C" fn(
            device: nvmlDevice_t,
        ...
        ::libloading::Error,
    >,
    pub nvmlDeviceSetPowerMode: Result<
        unsafe extern "C" fn(device: nvmlDevice_t, powerModeId: raw::c_uint) -> nvmlReturn_t,
        ::libloading::Error,
    >,
